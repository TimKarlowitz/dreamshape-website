        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="mt-6 text-lg font-normal text-gray-400">
              We wanted to create a safe space for YOU to keep track of and
              explore your dreams. Dreamshape offers a dream journal app that
              helps you to gain a deeper understanding of your inner self.
            </p>
          </div>
            ...
            <div className="flex flex-col items-center">
              <div className="relative w-24 h-24 rounded-xl group">
                ...
                <div className="relative inline-flex items-center justify-center w-24 h-24 rounded-xl bg-base-900">
                  <svg
                    className="w-12 h-12 text-gray-400 transition-all duration-200 group-hover:text-white"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
            ...
            <div className="lg:order-1">
              ...
              <blockquote className="mt-8">
                <p className="text-2xl font-medium leading-snug tracking-tight text-gray-900 sm:text-3xl">
                  “Since I started using Dreamshape, Ive gained profound
